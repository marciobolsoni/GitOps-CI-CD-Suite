###############################################################################
# VPC Module — marciobolsoni.cloud
# Creates a production-grade VPC with public, private, and data subnets
# across two availability zones with NAT Gateway and flow logs.
###############################################################################
